...
<head>
    ...
    <title>Añadir participacion</title>
</head>

<body>
    <div class="container">
        <h1>Añadir participacion</h1>
        <form method="POST" action="{{route('participaciones.store')}}">
            ...
            <div class="mb-3">
                ...
                <input type="text" required class="form-control" id="resultado" aria-describedby="nameHelp" name="resultado" placeholder="resultado evento.">
            </div> 
            <div class="mb-3">
                <label for="name" class="form-label">Premios:</label>
                <input type="text" required class="form-control" id="premios" aria-describedby="nameHelp" name="premios" placeholder="premios evento.">
            </div>  
            <div class="mt-3">
